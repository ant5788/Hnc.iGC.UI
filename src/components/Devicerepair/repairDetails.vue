    ...
    >
      <el-form :model="form" :rules="rules" ref="form" class="form_box">
        ...
        <el-form-item label="设备型号" prop="DeviceModel">
          <el-input v-model="form.DeviceModel" class="input_box" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item label="维修负责人" prop="RepairPersonnel">
          <el-input
            v-model="form.RepairPersonnel"
            class="input_box"
            disabled
          ></el-input>
        </el-form-item>
        <el-form-item label="维修状态" prop="RepairState">
          <el-select v-model="form.RepairState" disabled>
            <el-option
        ...
        <el-form-item label="维修时长" prop="RepairDuration">
          <el-input v-model="form.RepairDuration" class="input_box" disabled></el-input>
        </el-form-item>
        <el-form-item label="维修金额" prop="RepairCost">
          <el-input v-model="form.RepairCost" class="input_box" disabled></el-input>
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
