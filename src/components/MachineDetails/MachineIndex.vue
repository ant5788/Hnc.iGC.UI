  ...
  <div class="machine_box">
    ...
    <div class="machine_top_left">
      <dv-border-box-12 class="machine_details">
        <div class="title">▎机床详情
          <img src="../../assets/images/mechanic_icon/off_line_icon.png" class="img">
        </div>
        <div class="detail fl">
       ...
       <dv-border-box-12 class="machine_order">
         ...
         <p><span class="text">加工计数</span><span class="number">9999</span>
         <span class="text">程序号</span><span class="number">23</span>
         </p>
         <p><span class="text">程序名称</span><span class="number">../pro/O111</span></p>
       </dv-border-box-12>
    </div>
    <div class="machine_top_midle">
      <dv-border-box-12 class="Axios_info">
         <div class="title">▎实际位置</div>
          <div class="content">
              <div
                class="axisItem"
    ...
    <div class="machine_bottom">
      ...
      <dv-border-box-12 >
        <div class="multiplying-power">
            ...
            :key="i"
          >
            <img class="rotary-knob-img" :src="item.imgUrl" :alt="item.name" />
            <img
              class="pointer-img"
            ...
            />
            <div
              style="height: 30px; width: 104px; margin-left: 50%; transform: translate(-50%, -0.1rem); display: flex; flex-direction: row"
            >
              <img
                :src="item.iconImgUrl"
              ...
              />
              <div
                style="height: 30px; margin-left: 17px; line-height: 30px;"
              >
                {{ item.value }}%
              </div>
            </div>
...
.machine_box{
 ...
 .machine_top{
   width: 100%;
   display: flex;
.machine_top_left,.machine_top_midle,.machine_top_right{
  flex:1;
  height: 552px;
}
 }
 ...
 .machine_bottom_left,.machine_bottom_right{
    flex: 1; 
 }
   .multiplying-power {
     color: #fff;
